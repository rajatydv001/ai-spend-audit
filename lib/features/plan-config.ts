 ...
 * per rolling 30-day window (see AUDIT_LIMIT_WINDOW_MS below) and 3 PDF
 * exports; Pro expands both and enables AI insights and advanced analytics;
 * Enterprise is unlimited. Nothing here is client-derived.
 */
